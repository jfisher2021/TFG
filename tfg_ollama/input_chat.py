...
messages = [
  {
    'role': 'user',
    'content': """You are a planner for PDDL and I only want you to give me the execution plan. You need to take into account the following:
...
response = chat(
'deepseek-r1:70b',
messages=[*messages, {'role': 'user', 'content': messages[0]['content']}],
# stream=True,
)
