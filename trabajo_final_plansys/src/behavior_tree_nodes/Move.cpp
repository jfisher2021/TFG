...
#include "trabajo_final_plansys/behavior_tree_nodes/Move.hpp"
...
BT_REGISTER_NODES(factory)
{
  BT::NodeBuilder builder =
    ...
    {
      return std::make_unique<trabajo_final_plansys::Move>(
        name, "navigate_to_pose", config);
    };

  factory.registerBuilder<trabajo_final_plansys::Move>(
    "Move", builder);
}
