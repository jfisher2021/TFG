...
@configuration
- The configuration is loaded from `speech_services.src.user_config.UserConfig` and includes:
...
- Run the node:
    ```
    ros2 run speech_services stt_service
    ```
- Test the service:
    ```
...
from speech_services.src.user_config import UserConfig
import traceback
